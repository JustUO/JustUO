    ...
    public class PlagueBeastLord : BaseCreature, ICarvable, IScissorable
    {
        ...
        public bool IsBleeding
        {
            get
            {
                ...
                if (pack != null)
                {
                    ...
                    {
                        var blood = pack.Items[i] as PlagueBeastBlood;
        ...
        public virtual bool Scissor(Mobile from, Scissors scissors)
        {
            if (IsAccessibleTo(from))
                scissors.PublicOverheadMessage(MessageType.Regular, 0x3B2, 1071918);
        ...
        public override void OnDoubleClick(Mobile from)
        {
            if (IsAccessibleTo(from))
            {
                if (OpenedBy != null && Backpack != null)
                    ...
                    PrivateOverheadMessage(MessageType.Regular, 0x3B2, 1071917, from.NetState);
        ...
        public virtual bool IsAccessibleTo(Mobile check)
        {
            ...
            if (!InRange(check, 2))
                ...
                PrivateOverheadMessage(MessageType.Label, 0x3B2, 500365, check.NetState);
        ...
        {
            PublicOverheadMessage(MessageType.Regular, 0x3B2, 1071920);
            ...
            protected override void OnTick()
            {
                ...
                if (Count + 15 == Deadline)
                {
                    if (m_Lord.OpenedBy != null)
                        m_Lord.PublicOverheadMessage(MessageType.Regular, 0x3B2, 1071921);
