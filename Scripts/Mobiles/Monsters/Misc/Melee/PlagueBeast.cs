...
namespace Server.Mobiles
{
    ...
    public class PlagueBeast : BaseCreature, IDevourer
    {
            ...
            : base(AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            ...
            TotalDevoured = 0;
            m_DevourGoal = Utility.RandomMinMax(15, 25);
                // How many corpses must be devoured before a metal chest is awarded
        }
        ...
        private void IncreaseHits(int hp)
        {
            ...
            if (HitsMaxSeed >= maxhits)
            {
                ...
                var newHits = Hits + hp + Utility.RandomMinMax(10, 20);
