            ...
            if (!m_HasTeleportedAway && Hits < (HitsMax/2))
            {
                ...
                if (map != null)
                {
                    ...
                    for (var i = 0; i < 10; ++i)
                    {
                        ...
                        Effects.SendLocationParticles(EffectItem.Create(from, map, EffectItem.DefaultDuration), 0x3728,
                            10, 10, 2023);
                        Effects.SendLocationParticles(EffectItem.Create(to, map, EffectItem.DefaultDuration), 0x3728, 10,
                            10, 5023);
