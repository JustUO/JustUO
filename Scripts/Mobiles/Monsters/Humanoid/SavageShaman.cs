    ...
    public class SavageShaman : BaseCreature
    {
        ...
        public void BeginSavageDance()
        {
            ...
            if (list.Count >= 3)
            {
                ...
                {
                    var dancer = (SavageShaman) list[i];
            ...
            if (list.Count > 0)
            {
                switch (Utility.Random(3))
                {
                    case 0: /* greater heal */
                    {
                        ...
                        {
                            var isFriendly = (m is Savage || m is SavageRider || m is SavageShaman ||
                                              m is SavageRidgeback);
                            ...
                            var toHeal = (int) (Skills[SkillName.Magery].Value*0.4);
                    ...
                    case 1: /* lightning */
                    {
                        foreach (Mobile m in list)
                        {
                            ...
                            if (Core.AOS)
                            {
                                var baseDamage = 6 + (int) (Skills[SkillName.EvalInt].Value/5.0);
                    ...
                    case 2: /* poison */
                    {
                        foreach (Mobile m in list)
                        {
                            ...
                            var total = Skills[SkillName.Magery].Value + Skills[SkillName.Poisoning].Value;
