...
namespace Server.Items
{
    public class KingOfTheHillGauntlet : BaseChallengeGame
    {
        ...
        public static bool OnlyInChallengeGameRegion = true;           // if this is true, then the game can only be set up in a challenge game region
        ...
        public KingOfTheHillGauntlet(Mobile challenger) : base( 0x1414 )
        {
            ...
            {
                Name = XmlPoints.SystemText(100410) + " " + String.Format(XmlPoints.SystemText(100315), challenger.Name); // "Challenge by {0}"

            }
        }


        public KingOfTheHillGauntlet( Serial serial ) : base( serial )
        {
        }
        ...
        {
            from.SendGump( new KingOfTheHillGump( this, from ) );
        }
    }
}
