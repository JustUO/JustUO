...
namespace Server.Items
{
    public class DeathBall : Item
    {
		...
		public DeathBall( Serial serial ) : base( serial )
		{
		}
    ...
    public class DeathBallGauntlet : BaseChallengeGame
    {
        ...
        public DeathBallGauntlet(Mobile challenger) : base( 0x1414 )
        {
            ...
            {
                Name = XmlPoints.SystemText(100411) + " " + String.Format(XmlPoints.SystemText(100315), challenger.Name); // "Challenge by {0}"
            }
        }


        public DeathBallGauntlet( Serial serial ) : base( serial )
        {
        }
