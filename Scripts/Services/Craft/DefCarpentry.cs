    ...
    public class DefCarpentry : CraftSystem
    {
        ...
        public override void InitCraftList()
        {
            ...
            if (Core.ML)
            {
                ...
                index = AddCraft(typeof(ElvenWashBasinSouthDeed), 1044292, 1072865, 70.0, 95.0, typeof(Board), 1044041, 40, 1044351);
                ForceNonExceptional(index);
                SetNeededExpansion(index, Expansion.ML);

                index = AddCraft(typeof(ElvenWashBasinEastDeed), 1044292, 1073387, 70.0, 95.0, typeof(Board), 1044041, 40, 1044351);
                ForceNonExceptional(index);
                SetNeededExpansion(index, Expansion.ML);
            ...
            // Staves and Shields
            AddCraft(typeof(ShepherdsCrook), 1044295, 1023713, 78.9, 103.9, typeof(Board), 1044041, 7, 1044351);
            AddCraft(typeof(QuarterStaff), 1044295, 1023721, 73.6, 98.6, typeof(Board), 1044041, 6, 1044351);
            ...
            if (Core.SE)
            {
                ...
                index = AddCraft(typeof(Fukiya), 1044295, 1030229, 60.0, 85.0, typeof(Board), 1044041, 6, 1044351);
                SetNeededExpansion(index, Expansion.SE);
            ...
            if (Core.ML)
            {
                index = AddCraft(typeof(ElvenForgeDeed), 1044296, 1072875, 94.7, 119.7, typeof(Board), 1044041, 200, 1044351);
                ForceNonExceptional(index);
                SetNeededExpansion(index, Expansion.ML);
            }
            #endregion
