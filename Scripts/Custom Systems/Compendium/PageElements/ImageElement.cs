...
namespace Server.Gumps.Compendium
{
	...
	//                  7       7         8          7       7    10      9        8    
	//
	public class ImageElement : BaseCompendiumPageElement
	{
		...
		{
			RegisterElement("ImageElement", CreateImageElement);
			CompendiumPageEditor.RegisterElementType(typeof(ImageElement), CreateInstance, " Image      ");
		}

		//factory method
		public static BaseCompendiumPageElement CreateImageElement(XElement elementXml)
		{
			var elementToReturn = new ImageElement();
		...
		public override void Deserialize(XElement xml)
		{
			...
			{
				throw new Exception("Failed to parse ImageElement xml", e);
			}
		}
	}
}