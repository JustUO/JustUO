...
namespace Server.Gumps.Compendium
{
    ...
    public class TiledImageElement : BaseCompendiumPageElement
    {
        ...
        {
            TiledImageElement image = new TiledImageElement();
        ...
        {
            TiledImageElement elementToReturn = new TiledImageElement();
        ...
        public static BaseCompendiumPageElement CreateInstance()
        {
            ...
            image.Width = 100;
            image.Height = 100;
            image.Name = "new TiledImage";
            image.ElementType = "TiledImageElement";
            return image;
        }
