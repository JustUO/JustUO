...
namespace VitaNex.SuperGumps
{
	public abstract partial class SuperGump : Gump, IEquatable<SuperGump>, IDisposable
	{
		...
		public static SuperGump Send(SuperGump gump)
		{
			return gump != null ? (gump.Compiled ? gump.Refresh() : gump.Send()) : null;
		}
		...
		protected new virtual void Compile()
		{
			if (IsDisposed)
			{
				return;
