...
namespace VitaNex
{
	...
	public static partial class VitaNexCore
	{
		...
		{
			return CoreServices.FirstOrDefault(csi => csi.TypeOf == t || csi.TypeOf.IsEqualOrChildOf(t));
		}
		...
		public static void ConfigureServices()
		{
			...
			_CoreServices.Sort();
			_CoreServices.ForEach(ConfigureService);
		}
		...
		public static void InvokeServices()
		{
			...
			_CoreServices.ForEach(InvokeService);
		}
		...
		public static void SaveServices()
		{
			...
			_CoreServices.ForEach(SaveService);
		}
		...
		public static void LoadServices()
		{
			...
			_CoreServices.ForEach(LoadService);
		}
		...
		public static void DisposeServices()
		{
			...
			_CoreServices.ForEach(DisposeService);
		}
	...
	public sealed class CoreServiceAttribute : Attribute
	{
		...
		public CoreServiceAttribute(
			string name, string version = "1.0.0", int priority = TaskPriority.Medium, bool debug = false, bool quietMode = false)
		{
			Name = name;
			Version = version;
			Priority = priority;
	...
	public sealed class CoreServiceInfo : IComparable<CoreServiceInfo>
	{
		...
		{
			return csi == null ? -1 : (_Priority > csi.Priority ? -1 : (_Priority < csi.Priority ? 1 : 0));
		}
	...
	public sealed class CoreServiceListGump : ListGump<CoreServiceInfo>
	{
		...
		{
			list.Clear();
			list.AddRange(new List<CoreServiceInfo>(VitaNexCore.CoreServices));
