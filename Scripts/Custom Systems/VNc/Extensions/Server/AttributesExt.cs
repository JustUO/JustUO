...
namespace Server
{
	public static class AttributesExtUtility
	{
		...
		{
			((AosAttribute)0).GetValues<ulong>(), ((AosArmorAttribute)0).GetValues<ulong>(),
			((AosWeaponAttribute)0).GetValues<ulong>(), ((AosElementAttribute)0).GetValues<ulong>(),
			((SkillName)0).GetValues<ulong>(), ((SlayerName)0).GetValues<ulong>(), ((TalismanSlayerName)0).GetValues<ulong>()
		};
