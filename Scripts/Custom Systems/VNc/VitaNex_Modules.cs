...
namespace VitaNex
{
	...
	public static partial class VitaNexCore
	{
		...
		{
			return
				CoreModules.FirstOrDefault(cmi => cmi.TypeOf == t || cmi.TypeOf.IsSubclassOf(t) || cmi.TypeOf.IsAssignableFrom(t));
		}
		...
		public static void ConfigureModules()
		{
			...
			foreach (CoreModuleInfo cmi in types.Select(kvp => new CoreModuleInfo(kvp.Key, kvp.Value)))
			{
			...
			_CoreModules.Sort();
			_CoreModules.ForEach(ConfigureModule);
		}
		...
		public static void InvokeModules()
		{
			...
			_CoreModules.Sort();
			_CoreModules.ForEach(InvokeModule);
		}
		...
		public static void SaveModules()
		{
			...
			_CoreModules.Sort();
			_CoreModules.ForEach(SaveModule);
		}
		...
		public static void LoadModules()
		{
			...
			_CoreModules.Sort();
			_CoreModules.ForEach(LoadModule);
		}
		...
		public static void DisposeModules()
		{
			...
			_CoreModules.Sort();
			_CoreModules.ForEach(DisposeModule);
		}
	...
	public sealed class CoreModuleInfo : IComparable<CoreModuleInfo>
	{
		...
		{
			return cmi == null ? -1 : (_Priority > cmi.Priority ? -1 : (_Priority < cmi.Priority ? 1 : 0));
		}
