...
namespace Server
{
	...
	public sealed class Coords : ICoords, IComparable, IComparable<Coords>, IEquatable<Coords>
	{
		...
		public static bool operator ==(Coords l, IPoint2D r)
		{
			if (ReferenceEquals(l, null))
			{
		...
		public static bool operator ==(Coords l, IPoint3D r)
		{
			if (ReferenceEquals(l, null))
			{
				return ReferenceEquals(r, null);
		...
		public static bool operator ==(Coords l, ICoords r)
		{
			if (ReferenceEquals(l, null))
			{
				return ReferenceEquals(r, null);
