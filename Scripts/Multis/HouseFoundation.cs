...
namespace Server.Multis
{
	public enum FoundationType
	{
		...
		Dungeon,
		Brick,
		ElvenStone, // previously ElvenGrey
		ElvenWood, // preciously ElvenNatural
		ElvenSimple,
		ElvenPlain,
		Crystal,
		Shadow,
	...
	public class DesignStateDetailed : Packet
	{
			...
			: base( 0xD8 )
		{
			...
			for ( int i = 0; i < tiles.Length; ++i )
			{
					...
					default:
						{
							...
							stairBuffer[byteIndex++] = (byte) ( ( mte.m_ItemID >> 8 ) & 0x7F );
							stairBuffer[byteIndex++] = (byte) mte.m_ItemID;
				...
				{
					m_PlaneUsed[plane] = true;
					m_PlaneBuffers[plane][index] = (byte) ( ( mte.m_ItemID >> 8 ) & 0x7F );
					m_PlaneBuffers[plane][index + 1] = (byte) mte.m_ItemID;
				}
			}
