...
namespace Server.Engines.Quests
{
    public class MistakenIdentityQuest : BaseQuest
    {
        ...
        {
            AddObjective(new DeliverObjective(typeof (TuitionReimbursementForm), "tuition reimbursement form", 1,
                typeof (Gorrow), "Gorrow (Luna)"));
        ...
        {
            get { return QuestChain.TuitionReimbursement; }
        }

        public override Type NextQuest
        {
            get { return typeof (YouScratchMyBackQuest); }
        }
    ...
    public class YouScratchMyBackQuest : BaseQuest
    {
        ...
        public override Type NextQuest
        {
            get { return typeof (FoolingAernyaQuest); }
        }
    ...
    public class FoolingAernyaQuest : BaseQuest
    {
        ...
        {
            AddObjective(new DeliverObjective(typeof (SignedTuitionReimbursementForm),
                "signed tuition reimbursement form", 1, typeof (Aernya), "Aernya (Umbra)"));
        ...
        public override Type NextQuest
        {
            get { return typeof (NotQuiteThatEasyQuest); }
        }
    ...
    public class NotQuiteThatEasyQuest : BaseQuest
    {
        ...
        {
            AddObjective(new DeliverObjective(typeof (SignedTuitionReimbursementForm),
                "signed tuition reimbursement form", 1, typeof (Gnosos), "Master Gnosos (Bedlam)"));
        ...
        public override Type NextQuest
        {
            get { return typeof (ConvinceMeQuest); }
        }
    ...
    public class ConvinceMeQuest : BaseQuest
    {
        ...
        public override Type NextQuest
        {
            get { return typeof (TuitionReimbursementQuest); }
        }
    ...
    public class TuitionReimbursementQuest : BaseQuest
    {
        ...
        {
            AddObjective(new DeliverObjective(typeof (CompletedTuitionReimbursementForm),
                "completed tuition reimbursement form", 1, typeof (Aernya), "Aernya (Umbra)"));
        ...
        public override Type NextQuest
        {
            get { return typeof (TheGoldenHornQuest); }
        }
