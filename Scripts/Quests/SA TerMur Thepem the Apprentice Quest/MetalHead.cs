...
namespace Server.Engines.Quests
{
    public class MetalHead : BaseQuest
    {
        public MetalHead()
        {
            ...
            AddObjective(new ObtainObjective(typeof (PileofInspectedDullCopperIngots),
                "Pile of Inspected DullCopper Ingots", 1, 0x1BEA));
            AddObjective(new ObtainObjective(typeof (PileofInspectedShadowIronIngots),
                "Pile of Inspected ShadowIron Ingots", 1, 0x1BEA));
        ...
        {
            get { return typeof (PinkistheNewBlack); }
        }
