...
namespace Server.Engines.Quests
{
    public class PinkistheNewBlack : BaseQuest
    {
        ...
        {
            AddObjective(new ObtainObjective(typeof (SearedFireAntGoo), "Seared Fire Ant Goo", 5, 0x2f5f));
            AddObjective(new ObtainObjective(typeof (PileofInspectedAgapiteIngots), "Pile of Inspected Agapite Ingots",
                1, 0x1BEA));
