...
namespace Server.Engines.Quests
{
    public class FriendsOfTheLibraryQuest : BaseQuest
    {
        ...
        {
            AddObjective(new DeliverObjective(typeof (LibraryApplication), "friends of the library application", 1,
        ...
        {
            get { return QuestChain.LibraryFriends; }
        }

        public override Type NextQuest
        {
            get { return typeof (BureaucraticDelayQuest); }
        }
    ...
    public class BureaucraticDelayQuest : BaseQuest
    {
        ...
        {
            AddObjective(new DeliverObjective(typeof (SealingWaxOrder), "sealing wax order", 1, typeof (Petrus),
                "Petrus (Ilshenar)"));
        ...
        public override Type NextQuest
        {
            get { return typeof (TheSecretIngredientQuest); }
        }
    ...
    public class TheSecretIngredientQuest : BaseQuest
    {
        ...
        public override Type NextQuest
        {
            get { return typeof (SpecialDeliveryQuest); }
        }
    ...
    public class SpecialDeliveryQuest : BaseQuest
    {
        ...
        {
            AddObjective(new DeliverObjective(typeof (OfficialSealingWax), "sealing wax", 1, typeof (Sarakki),
                "Sarakki (Britain)"));
        ...
        public override Type NextQuest
        {
            get { return typeof (AccessToTheStacksQuest); }
        }
    ...
    public class AccessToTheStacksQuest : BaseQuest
    {
        ...
        {
            AddObjective(new DeliverObjective(typeof (NotarizedApplication), "notarized application", 1, typeof (Verity),
                "Verity (Britain)"));

            AddReward(new BaseReward(typeof (FriendOfTheLibraryToken), 1072749));
                // Friends of the Library Membership Token.
        }
