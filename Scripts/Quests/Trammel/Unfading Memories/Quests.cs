...
namespace Server.Engines.Quests
{
    ...
    public class UnfadingMemoriesTwoQuest : BaseQuest
    {
        ...
        {
            AddObjective(new DeliverObjective(typeof (PortraitOfTheBride), "portrait of the bride", 1, typeof (Thalia),
                "Bride"));
        ...
        public override Type NextQuest
        {
            get { return typeof (UnfadingMemoriesThreeQuest); }
        }
