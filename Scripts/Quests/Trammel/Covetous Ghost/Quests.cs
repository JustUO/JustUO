...
namespace Server.Engines.Quests
{
    public class GhostOfCovetousQuest : BaseQuest
    {
        ...
        {
            AddObjective(new DeliverObjective(typeof (SpiritBottle), "spirit bottle", 1, typeof (Frederic),
                "The Ghost of Frederic Smithson"));

            AddReward(new BaseReward(1075284));
                // Return the filled Spirit Bottle to Griswolt the Master Necromancer to receive a reward.
        }

        public override QuestChain ChainID
        {
            get { return QuestChain.CovetousGhost; }
        }

        public override Type NextQuest
        {
            get { return typeof (SaveHisDadQuest); }
        }
    ...
    public class SaveHisDadQuest : BaseQuest
    {
        ...
        {
            AddObjective(new DeliverObjective(typeof (DreadSpiderSilk), "dread spider silk", 1, typeof (Leon), "Leon",
                600));

            AddReward(new BaseReward(1075339));
        ...
        public override Type NextQuest
        {
            get { return typeof (FathersGratitudeQuest); }
        }
    ...
    public class FathersGratitudeQuest : BaseQuest
    {
        ...
        {
            AddObjective(new DeliverObjective(typeof (AlchemistsBandage), "alchemist's bandage", 1, typeof (Andros),
                "Andros"));
