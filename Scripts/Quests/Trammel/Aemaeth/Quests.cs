...
namespace Server.Engines.Quests
{
    public class AemaethOneQuest : BaseQuest
    {
        ...
        {
            AddObjective(new DeliverObjective(typeof (BasinOfCrystalClearWater), "basin of crystal clear water", 1,
                typeof (Szandor), "Szandor"));
        ...
        {
            get { return QuestChain.Aemaeth; }
        }

        public override Type NextQuest
        {
            get { return typeof (AemaethTwoQuest); }
        }
