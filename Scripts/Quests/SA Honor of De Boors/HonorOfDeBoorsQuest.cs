...
namespace Server.Engines.Quests
{
    public class HonorOfDeBoorsQuest : BaseQuest
    {
        ...
        {
            get { return QuestChain.HonorOfDeBoors; }
        }

        public override Type NextQuest
        {
            get { return typeof (JackTheVillainQuest); }
        }
    ...
    public class JackTheVillainQuest : BaseQuest
    {
        ...
        {
            AddObjective(new DeliverObjective(typeof (BagOfJewels), "Bag of Jewels", 1, typeof (JackLoanShark),
                "Jack the Loan Shark"));
        ...
        public override Type NextQuest
        {
            get { return typeof (SavedHonorQuest); }
        }
    ...
    public class SavedHonorQuest : BaseQuest
    {
        ...
        {
            AddObjective(new DeliverObjective(typeof (DeBoorShield), "Ancestral Shield", 1, typeof (DerekMerchant),
                "Derek the Merchant"));
