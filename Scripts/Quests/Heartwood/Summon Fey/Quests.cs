...
namespace Server.Engines.Quests
{
    public class FirendOfTheFeyQuest : BaseQuest
    {
        public FirendOfTheFeyQuest()
        {
            ...
            AddReward(new BaseReward(1074874));
        ...
        {
            get { return QuestChain.SummonFey; }
        }

        public override Type NextQuest
        {
            get { return typeof (TokenOfFriendshipQuest); }
        }
    ...
    public class TokenOfFriendshipQuest : BaseQuest
    {
        ...
        {
            AddObjective(new DeliverObjective(typeof (GiftForArielle), "gift for Arielle", 1, typeof (Arielle),
                "Arielle"));
        ...
        public override Type NextQuest
        {
            get { return typeof (AllianceQuest); }
        }
