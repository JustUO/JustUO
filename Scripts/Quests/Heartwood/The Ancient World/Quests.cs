...
namespace Server.Engines.Quests
{
    public class TheAncientWorldQuest : BaseQuest
    {
        ...
        {
            get { return QuestChain.AncientWorld; }
        }
    ...
    public class TheGoldenHornQuest : BaseQuest
    {
        ...
        {
            AddObjective(new DeliverObjective(typeof (MapFragment), "fragment of a map", 1, typeof (Braen),
                "Braen (The Heartwood)"));
        ...
        public override Type NextQuest
        {
            get { return typeof (BullishQuest); }
        }
    ...
    public class BullishQuest : BaseQuest
    {
        ...
        public override Type NextQuest
        {
            get { return typeof (LostCivilizationQuest); }
        }
