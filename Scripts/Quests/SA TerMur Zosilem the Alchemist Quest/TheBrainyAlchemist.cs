...
namespace Server.Engines.Quests
{
    public class TheBrainyAlchemist : BaseQuest
    {
        public TheBrainyAlchemist()
        {
            ...
            AddObjective(new ObtainObjective(typeof (InspectedKegofTotalRefreshment),
                "Inspected Keg of Total Refreshment", 1, 0x1940));
            AddObjective(new ObtainObjective(typeof (InspectedKegofGreaterPoison), "Inspected Keg of Greater Poison", 1,
                0x1940));
        ...
        {
            get { return "The Brainy Alchemist"; }
        }
