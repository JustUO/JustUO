...
namespace Server.Engines.Quests
{
    public class PureValorite : BaseQuest
    {
        public PureValorite()
        {
            ...
            AddObjective(new ObtainObjective(typeof (PileofInspectedValoriteIngots), "Pile of Inspected Valorite Ingots",
                1, 0x1BEA));
        ...
        {
            get { return typeof (TheForbiddenFruit); }
        }
