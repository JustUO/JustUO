...
namespace Server.Engines.Quests
{
    public class VilePoisonQuest : BaseQuest
    {
        ...
        {
            AddObjective(new DeliverObjective(typeof (TaintedTreeSample), "tainted tree sample", 1, typeof (Ioseph),
                "Ioseph (Jhelom)"));
        ...
        {
            get { return QuestChain.BlightedGrove; }
        }

        public override Type NextQuest
        {
            get { return typeof (RockAndHardPlaceQuest); }
        }
    ...
    public class RockAndHardPlaceQuest : BaseQuest
    {
        ...
        public override Type NextQuest
        {
            get { return typeof (SympatheticMagicQuest); }
        }
    ...
    public class SympatheticMagicQuest : BaseQuest
    {
        ...
        public override Type NextQuest
        {
            get { return typeof (AlreadyDeadQuest); }
        }
    ...
    public class EurekaQuest : BaseQuest
    {
        public EurekaQuest()
        {
            AddObjective(new DeliverObjective(typeof (SealedNotesForJamal), "sealed notes for jamal", 1, typeof (Jamal),
                "Jamal (near Blighted Grove)"));
        ...
        public override Type NextQuest
        {
            get { return typeof (SubContractingQuest); }
        }
