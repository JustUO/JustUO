...
namespace Server.Engines.Quests
{
    public class TheJoysOfLifeQuest : BaseQuest
    {
        ...
        public override void GiveRewards()
        {
            ...
            Owner.SendLocalizedMessage(1074944, null, 0x23);
    ...
    public class DefendingTheHerdQuest : BaseQuest
    {
        ...
        *proud head-toss* */
        ...
        public override void GiveRewards()
        {
            ...
            Owner.SendLocalizedMessage(1074942, null, 0x23);
    ...
    public class CaretakerOfTheLandQuest : BaseQuest
    {
        ...
        public override void GiveRewards()
        {
            ...
            Owner.SendLocalizedMessage(1074941, null, 0x23);
    ...
    public class SeasonsQuest : BaseQuest
    {
        ...
        public override void GiveRewards()
        {
            ...
            Owner.SendLocalizedMessage(1074940, null, 0x23);
    ...
    public class TheBalanceOfNatureQuest : BaseQuest
    {
        ...
        public override void GiveRewards()
        {
            ...
            Owner.SendLocalizedMessage(1074943, null, 0x23);
    ...
    public class WisdomOfTheSphynxQuest : BaseQuest
    {
        ...
        public override void GiveRewards()
        {
            ...
            Owner.SendLocalizedMessage(1074945, null, 0x23);
