...
namespace Server.Engines.Quests
{
    public class IngenuityQuest : BaseQuest
    {
        ...
        public override void GiveRewards()
        {
            ...
            Owner.SendLocalizedMessage(1074946, null, 0x23);
    ...
    public class HeaveHoQuest : BaseQuest
    {
        public HeaveHoQuest()
        {
            AddObjective(new DeliverObjective(typeof (CrateForSledge), "crates for Sledge", 5, typeof (Sledge),
                "Sledge (Buc's Den)", 3600));
        ...
        public override void GiveRewards()
        {
            ...
            Owner.SendLocalizedMessage(1074948, null, 0x23);
    ...
    public class ResponsibilityQuest : BaseQuest
    {
        ...
        *worried frown*  But my grandfather has sent word that he has been hurt and needs me to tend his wounds.  
        ...
        public override void GiveRewards()
        {
            ...
            Owner.SendLocalizedMessage(1074949, null, 0x23);
    ...
    public class AllSeasonAdventurerQuest : BaseQuest
    {
        ...
        public override void GiveRewards()
        {
            ...
            Owner.SendLocalizedMessage(1074947, null, 0x23);
