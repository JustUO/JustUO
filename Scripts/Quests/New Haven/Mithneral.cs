...
namespace Server.Engines.Quests
{
    public class ScholarlyTaskQuest : BaseQuest
    {
        ...
        {
            Owner.SendLocalizedMessage(1077606, null, 0x23);
                // You have achieved the rank of Apprentice Scholar. Return to Mithneral in New Haven to receive your arcane prize.
