...
namespace Server.Engines.Quests
{
    public class TheWayOfTheBladeQuest : BaseQuest
    {
        ...
        {
            Owner.SendLocalizedMessage(1077664, null, 0x23);
                // You have achieved the rank of Apprentice Swordsman. Return to Jockles in New Haven to see what kind of reward he has waiting for you. Hopefully he'll be a little nicer this time!
