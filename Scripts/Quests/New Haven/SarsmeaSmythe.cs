...
namespace Server.Engines.Quests
{
    public class TheInnerWarriorQuest : BaseQuest
    {
        ...
        {
            Owner.SendLocalizedMessage(1077702, null, 0x23);
                // You have achieved the rank of Apprentice Stoic (for Focus). Return to Sarsmea Smythe in New Haven to see what kind of reward she has waiting for you. 
