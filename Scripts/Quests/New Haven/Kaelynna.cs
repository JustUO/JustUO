...
namespace Server.Engines.Quests
{
    public class TheMagesApprenticeQuest : BaseQuest
    {
        ...
        {
            Owner.SendLocalizedMessage(1077580, null, 0x23);
                // You have achieved the rank of Apprentice Mage. Return to Kaelynna in New Haven to receive your arcane prize.
