...
namespace Server.Engines.Quests
{
    public class WalkingSilentlyQuest : BaseQuest
    {
        ...
        {
            Owner.SendLocalizedMessage(1078181, null, 0x23);
                // You have achieved the rank of Apprentice Rogue (for Stealth). Return to Jun in New Haven to claim your reward.
