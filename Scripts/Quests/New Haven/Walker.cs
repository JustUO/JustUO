...
namespace Server.Engines.Quests
{
    public class EyesOfRangerQuest : BaseQuest
    {
        ...
        {
            Owner.SendLocalizedMessage(1078220, null, 0x23);
                // You have achieved the rank of Apprentice Ranger (for Tracking). Return to Walker in New Haven to claim your reward.
