...
namespace Server.Engines.Quests
{
    public class StoppingTheWorldQuest : BaseQuest
    {
        ...
        {
            Owner.SendLocalizedMessage(1077600, null, 0x23);
                // You have achieved the rank of Apprentice Stoic (for Meditation). Return to Gustar in New Haven to receive your arcane prize.
