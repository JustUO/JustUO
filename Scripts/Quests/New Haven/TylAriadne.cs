...
namespace Server.Engines.Quests
{
    public class ThouAndThineShieldQuest : BaseQuest
    {
        ...
        {
            Owner.SendLocalizedMessage(1077710, null, 0x23);
                // You have achieved the rank of Apprentice Warrior (for Parrying). Return to Tyl Ariadne in New Haven as soon as you can to claim your reward.
