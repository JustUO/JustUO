...
namespace Server.Engines.Quests
{
    public class ScribingArcaneKnowledgeQuest : BaseQuest
    {
        ...
        {
            Owner.SendLocalizedMessage(1077618, null, 0x23);
                // You have achieved the rank of Apprentice Scribe. Return to Jillian in New Haven to receive your arcane prize.
