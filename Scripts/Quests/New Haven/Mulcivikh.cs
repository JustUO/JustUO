...
namespace Server.Engines.Quests
{
    public class TheAllureOfDarkMagicQuest : BaseQuest
    {
        ...
        {
            Owner.SendLocalizedMessage(1078042, null, 0x23);
                // You have achieved the rank of Apprentice Necromancer. Return to Mulcivikh in New Haven to receive the knowledge you desire.
