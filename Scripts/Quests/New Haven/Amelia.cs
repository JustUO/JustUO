...
namespace Server.Engines.Quests
{
    public class TheRightToolForTheJobQuest : BaseQuest
    {
        ...
        {
            AddObjective(new ApprenticeObjective(SkillName.Tinkering, 50, "Springs And Things Workshop", 1077742,
                1077743));
        ...
        *Amelia smiles*<br><br>At least you know where to find me if you change your mind, since I rarely spend time outside 
        ...
        {
            Owner.SendLocalizedMessage(1077747, null, 0x23);
                // You have achieved the rank of Apprentice Tinker. Talk to Amelia Youngstone in New Haven to see what kind of reward she has waiting for you.
