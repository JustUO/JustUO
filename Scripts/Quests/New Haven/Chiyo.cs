...
namespace Server.Engines.Quests
{
    public class BecomingOneWithTheShadowsQuest : BaseQuest
    {
        ...
        {
            Owner.SendLocalizedMessage(1078171, null, 0x23);
                // You have achieved the rank of Apprentice Rogue (for Hiding). Return to Chiyo in New Haven to claim your reward.
