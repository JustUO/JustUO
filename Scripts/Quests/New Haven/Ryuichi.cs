...
namespace Server.Engines.Quests
{
    public class TheArtOfStealthQuest : BaseQuest
    {
        ...
        {
            Owner.SendLocalizedMessage(1078161, null, 0x23);
                // You have achieved the rank of Apprentice Ninja. Return to Ryuichi in New Haven to see what kind of reward he has waiting for you.
