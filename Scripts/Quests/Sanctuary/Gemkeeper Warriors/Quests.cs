...
namespace Server.Engines.Quests
{
    public class WarriorsOfTheGemkeeperQuest : BaseQuest
    {
        ...
        {
            get { return QuestChain.GemkeeperWarriors; }
        }

        public override Type NextQuest
        {
            get { return typeof (CloseEnoughQuest); }
        }
    ...
    public class CloseEnoughQuest : BaseQuest
    {
        ...
        {
            AddObjective(new DeliverObjective(typeof (MapFragment), "fragment of a map", 1, typeof (Canir),
                "Canir (Sanctuary)"));
        ...
        public override Type NextQuest
        {
            get { return typeof (TakingTheBullByTheHornsQuest); }
        }
    ...
    public class TakingTheBullByTheHornsQuest : BaseQuest
    {
        ...
        public override Type NextQuest
        {
            get { return typeof (EmissaryToTheMinotaurQuest); }
        }
