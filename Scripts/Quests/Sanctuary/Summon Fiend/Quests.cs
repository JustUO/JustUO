...
namespace Server.Engines.Quests
{
    public class FiendishFriendsQuest : BaseQuest
    {
        public FiendishFriendsQuest()
        {
            ...
            AddReward(new BaseReward(1074873));
        ...
        {
            get { return QuestChain.SummonFiend; }
        }

        public override Type NextQuest
        {
            get { return typeof (CrackingTheWhipQuest); }
        }
    ...
    public class CrackingTheWhipQuest : BaseQuest
    {
        ...
        public override Type NextQuest
        {
            get { return typeof (IronWillQuest); }
        }
    ...
    public class IronWillQuest : BaseQuest
    {
        ...
        public override Type NextQuest
        {
            get { return typeof (TheBrainsOfTheOperationQuest); }
        }
