...
namespace Server.Engines.Quests
{
    ...
    public class WeavingFriendshipsQuest : BaseQuest
    {
        ...
        {
            AddObjective(new DeliverObjective(typeof (LetterOfIntroduction), "Letter of Introduction", 1,
                typeof (Dermott), "Dermott (Vesper)"));
        ...
        public override Type NextQuest
        {
            get { return typeof (NewSpinQuest); }
        }
    ...
    public class NewSpinQuest : BaseQuest
    {
        public NewSpinQuest()
        {
            AddObjective(new DeliverObjective(typeof (MasteringWeaving), "Mastering the Art of Weaving", 1,
                typeof (Laifem), "Laifem (Royal City)"));
