    ...
    public class GenTeleporter
    {
        ...
        public class TeleportersCreator
        {
            ...
            public void CreateTeleportersMap(Map map)
            {
                ...
                this.CreateTeleporter(5825, 631, 5, 2042, 215, 14, map, true);
                this.CreateTeleporter(5825, 631, 5, 2043, 215, 14, map, true);
                ...
                this.CreateTeleporter(5243, 1007, 0, 1176, 2635, 0, map, true);
                this.CreateTeleporter(5244, 1007, 0, 1177, 2635, 0, map, true);
                ...
                this.CreateTeleporter(5704, 146, -45, 5705, 305, 7, map, false);
                this.CreateTeleporter(5704, 147, -45, 5705, 306, 7, map, false);
                ...
                this.CreateTeleporter(5706, 305, 12, 5705, 146, -45, map, false);
                this.CreateTeleporter(5706, 306, 12, 5705, 147, -45, map, false);
            ...
            {
                // UnderWorld to SA
                this.CreateTeleporter(1125, 1076, -117, 520, 920, 39, map, Map.TerMur, false);
                this.CreateTeleporter(1126, 1076, 15, 521, 920, 39, map, Map.TerMur, false);
                //SA to Under
                this.CreateTeleporter(519, 919, 39, 1125, 1075, -117, map, Map.TerMur, false);
                this.CreateTeleporter(520, 919, 39, 1125, 1075, -117, map, Map.TerMur, false);
                this.CreateTeleporter(521, 919, 39, 1126, 1075, -117, map, Map.TerMur, false);
                this.CreateTeleporter(522, 919, 36, 1126, 1075, -117, map, Map.TerMur, false);
                ...
                this.CreateTeleporter(996, 3841, -41, 33, 240, 5, map, Map.TerMur, false);
                this.CreateTeleporter(997, 3841, -41, 34, 240, 5, map, Map.TerMur, false);
                this.CreateTeleporter(998, 3841, -41, 35, 240, 5, map, Map.TerMur, false);
                this.CreateTeleporter(999, 3841, -41, 36, 240, 5, map, Map.TerMur, false);
                this.CreateTeleporter(1000, 3841, -41, 37, 240, 5, map, Map.TerMur, false);
                //Tomb of Kings To Holy City
                this.CreateTeleporter(33, 241, 7, 996, 3842, -41, map, Map.TerMur, false);
                this.CreateTeleporter(34, 241, 7, 997, 3842, -41, map, Map.TerMur, false);
                this.CreateTeleporter(35, 241, 7, 998, 3842, -41, map, Map.TerMur, false);
                this.CreateTeleporter(36, 241, 7, 999, 3842, -41, map, Map.TerMur, false);
                this.CreateTeleporter(37, 241, 7, 1000, 3842, -41, map, Map.TerMur, false);
                ...
                this.CreateTeleporter(511, 584, 11, 6992, 1367, -15, map, Map.Felucca, false);
                this.CreateTeleporter(512, 584, 11, 6992, 1367, -15, map, Map.Felucca, false);
                this.CreateTeleporter(513, 584, 11, 6993, 1367, -15, map, Map.Felucca, false);
                this.CreateTeleporter(514, 584, 11, 6993, 1367, -15, map, Map.Felucca, false);
                //Abyssal Inferno Spawn to Abyss
                this.CreateTeleporter(7149, 756, 25, 511, 585, 11, map, Map.Felucca, false);

                //Underworld to fireisland
                this.CreateTeleporter(1125, 1215, 5, 4194, 3261, 5, map, Map.Trammel, false);
                this.CreateTeleporter(1126, 1215, 5, 4194, 3261, 5, map, Map.Trammel, false);
                this.CreateTeleporter(1127, 1215, 5, 4194, 3261, 5, map, Map.Trammel, false);
                this.CreateTeleporter(1128, 1215, 5, 4194, 3261, 5, map, Map.Trammel, false);
                this.CreateTeleporter(1129, 1215, 5, 4194, 3261, 5, map, Map.Trammel, false);
                this.CreateTeleporter(1130, 1215, 5, 4194, 3261, 5, map, Map.Trammel, false);
                this.CreateTeleporter(1131, 1215, 5, 4194, 3261, 5, map, Map.Trammel, false);

                //Underworld to Naverys Lair
                this.CreateTeleporter(1080, 974, -20, 1081, 883, -5, map, Map.TerMur, false);
                this.CreateTeleporter(1080, 975, -20, 1081, 883, -5, map, Map.TerMur, false);
                this.CreateTeleporter(1081, 974, -20, 1081, 883, -5, map, Map.TerMur, false);
                this.CreateTeleporter(1081, 975, -20, 1081, 883, -5, map, Map.TerMur, false);

                //Naverys Lair To Underworld
                this.CreateTeleporter(1079, 882, 0, 1080, 977, -21, map, Map.TerMur, false);
                this.CreateTeleporter(1079, 883, 0, 1080, 977, -21, map, Map.TerMur, false);
                this.CreateTeleporter(1079, 884, 0, 1080, 977, -21, map, Map.TerMur, false);
                this.CreateTeleporter(1079, 885, 0, 1080, 977, -21, map, Map.TerMur, false);

                //First Dragons Lair Entrance to Dragons Lair Entrance two
                this.CreateTeleporter(841, 272, 30, 434, 152, 0, map, Map.TerMur, false);
                this.CreateTeleporter(841, 273, 30, 434, 153, 0, map, Map.TerMur, false);

                this.CreateTeleporter(841, 287, 30, 433, 167, 0, map, Map.TerMur, false);
                this.CreateTeleporter(843, 286, 22, 433, 166, 0, map, Map.TerMur, false);

                //Dragons Lair Entrance two to First Dragons Lair Entrance
                this.CreateTeleporter(442, 152, -38, 850, 272, -11, map, Map.TerMur, false);
                this.CreateTeleporter(442, 153, -38, 850, 273, -11, map, Map.TerMur, false);

                this.CreateTeleporter(442, 166, -38, 850, 286, -11, map, Map.TerMur, false);
                this.CreateTeleporter(442, 167, -38, 850, 287, -11, map, Map.TerMur, false);
            }
            ...
            public void CreateTeleportersFelucca(Map map)
            {
                ...
                //PrimeevilLich Spawn to Abyss
                this.CreateTeleporter(6992, 1367, -15, 511, 585, 11, map, Map.TerMur, false);
                this.CreateTeleporter(6993, 1367, -15, 512, 585, 11, map, Map.TerMur, false);
                this.CreateTeleporter(6994, 1367, -15, 513, 585, 11, map, Map.TerMur, false);
            }
            ...
            public int CreateTeleporters()
            {
                ...
                this.CreateTeleportersMap5(Map.TerMur);
                return this.m_Count;
            }
        }
    }
